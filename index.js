...
var config = {
    me: process.env.TWITTER_ACCOUNT || 'StoriesInData', // The authorized account with a list to retweet.
    myList: process.env.TWITTER_LIST 'data-driven-storytellers', // The list we want to retweet.
    regexFilter: process.env.REGEX_FILTER || '', // Accept only tweets matching this regex pattern.
    regexReject: process.env.REGEX_REJECT || '(RT|@)', // AND reject any tweets matching this regex pattern.
